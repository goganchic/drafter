...
const std::string SerializeKey::ResourcePrototypes = "resourcePrototypes";
const std::string SerializeKey::ResourcePrototype = "resourcePrototype";
...
const std::string SerializeKey::BaseNames = "baseNames";
